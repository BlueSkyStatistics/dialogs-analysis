...
class chiSquareAssociationSummarized extends baseModal {
    static dialogId = 'chiSquareAssociationSummarized'
    static t = baseModal.makeT(chiSquareAssociationSummarized.dialogId)

  constructor() {
    var config = {
            id: chiSquareAssociationSummarized.dialogId,
      label: chiSquareAssociationSummarized.t('title'),
      modalType: "two",
...
`
    ...
    var objects = {
      ...
      label_table_cols: { el: new labelVar(config, { label: chiSquareAssociationSummarized.t('label_table_cols'), style: "mt-2", h: 6 }) },
      table_cols: {
      ...
      // Optional row labels
     // label_row_labels: { el: new labelVar(config, { label: chiSquareAssociationSummarized.t('label_row_labels'), style: "mt-3", h: 6 }) },
    /*   row_labels: {
   ...
   /*    row_labels: {
                el: new input(config, {
                    no: 'row_labels',
                    label: chiSquareAssociationSummarized.t('row_labels'),
                    placeholder: "",
                    required: true,
                    type: "character",
 ...
 */
      // Cell contents
      label_cell_contents: { el: new labelVar(config, { label: chiSquareAssociationSummarized.t('label_cell_contents'), style: "mt-3", h: 6 }) },
      chk_counts: {
        el: new checkbox(config, {
          label: chiSquareAssociationSummarized.t('opt_counts'),
          no: "chk_counts",
          state: "checked",
          extraction: "Boolean"
        })
      ...
      chk_margins: {
        el: new checkbox(config, {
          label: chiSquareAssociationSummarized.t('opt_margins'),
          no: "chk_margins",
          state: "checked",
          extraction: "Boolean"
        })
      ...
      chk_expected: {
        el: new checkbox(config, {
          label: chiSquareAssociationSummarized.t('opt_expected'),
          no: "chk_expected",
          state: "checked",
          extraction: "Boolean"
        })
      ...
      chk_contrib: {
        el: new checkbox(config, {
          label: chiSquareAssociationSummarized.t('opt_contrib'),
          no: "chk_contrib",
          state: "checked",
          extraction: "Boolean"
        })
      ...
      chk_raw_resid: {
        el: new checkbox(config, {
          label: chiSquareAssociationSummarized.t('opt_raw_resid'),
          no: "chk_raw_resid",
          state: "",
          extraction: "Boolean"
        })
      ...
      chk_std_resid: {
        el: new checkbox(config, {
          label: chiSquareAssociationSummarized.t('opt_std_resid'),
          no: "chk_std_resid",
          state: "",
          extraction: "Boolean"
        })
      ...
      chk_adj_resid: {
        el: new checkbox(config, {
          label: chiSquareAssociationSummarized.t('opt_adj_resid'),
          no: "chk_adj_resid",
          state: "",
          extraction: "Boolean"
        })
    ...
    super(config, objects, content);
        ...
        this.help = {
            title: chiSquareAssociationSummarized.t('help.title'),
            r_help: chiSquareAssociationSummarized.t('help.r_help'), //Fix by Anil //r_help: "help(data,package='utils')",
            body: chiSquareAssociationSummarized.t('help.body')
        }
;
  }
}
...
module.exports = {
    render: () => new chiSquareAssociationSummarized().render()
}
