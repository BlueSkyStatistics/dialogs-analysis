...
var localization = {
    en: {
        title: "Targeting Items, Multi-Line Format",
        navigation: "Targeting Items, Multi-Line Format",
        src: "Columns",
        idcolname: "Transaction ID variable name",
        itemcolname: "Variable containing the transaction items",
		...
		label3: "Enter transations items you are intreseted in, for e.g. if you are interested in what items people buy before they buy milk, enter milk in the textbox for right hand side (RHS) below. Since all other items can appear on LHS check radio button relating to default appearence to LHS.",
...
class targetingItemsMultilineData extends baseModal {
    constructor() {
        var config = {
            id: "targetingItemsMultilineData",
...
module.exports.item = new targetingItemsMultilineData().render()