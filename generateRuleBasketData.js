...
var localization = {
    en: {
        title: "Generate Rules, Basket Format",
        navigation: "Generate Rules, Basket Format",
        src: "Columns",
...
module.exports.item = new generateRuleBasketData().render()