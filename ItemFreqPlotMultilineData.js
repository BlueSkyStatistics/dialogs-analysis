...
var localization = {
    en: {
        title: "Item Frequency Plot, Multi-Line Format",
        navigation: "Item Frequency Plot, Multi-Line Format",
...
module.exports.item = new ItemFreqPlotMultilineData().render()