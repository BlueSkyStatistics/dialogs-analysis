...
class proportionTestSingleSample extends baseModal {
    constructor() {
        var config = {
            id: "proportionTestSingleSample",
            label: localization.en.title,
            modalType: "two",
            RCode: `
BSky_Factor_Variable_Count_Table = xtabs( ~{{selected.tvarbox1 | safe}} , data= {{dataset.name}})
BSkyFormat(BSky_Factor_Variable_Count_Table,singleTableOutputHeader="Counts")
...
BSkyFormat(BSky_Single_Sample_Proportion_Test)
#remove(BSky_Factor_Variable_Count_Table)
#remove(BSky_Single_Sample_Proportion_Test)
`
        }
        var objects = {
...
module.exports.item = new proportionTestSingleSample().render()