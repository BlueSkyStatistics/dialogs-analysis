...
class targetingItemsMultiVarFormat extends baseModal {
    static dialogId = 'targetingItemsMultiVarFormat'
    static t = baseModal.makeT(targetingItemsMultiVarFormat.dialogId)

    constructor() {
        var config = {
            id: targetingItemsMultiVarFormat.dialogId,
            label: targetingItemsMultiVarFormat.t('title'),
            modalType: "two",
            RCode: `
library(arules);
library(arulesViz);
...
`
        ...
        var objects = {
			...
			el: new srcVariableList(config, {
                    label: targetingItemsMultiVarFormat.t('src'),
                    no: "src",
					action: "move"
				}) 
			},
            destination: {
                el: new dstVariableList(config, {
                    label: targetingItemsMultiVarFormat.t('destination'),
                    no: "destination",
			...
			prunerules: { 
				el: new checkbox(config, { 
					label: targetingItemsMultiVarFormat.t('prunerules'), 
					newline:true, 
                    no: "prunerules", 
                    state: "checked",
					extraction: "Boolean" 
			...
			graphs: { 
				el: new checkbox(config, {
					label: targetingItemsMultiVarFormat.t('graphs'), 
					newline:true, 
                    no: "graphs", 
					extraction: "Boolean" 
				}) 
            ...
            label1: { 
				el: new labelVar(config, { 
					label: targetingItemsMultiVarFormat.t('label1'), 
                    no: "label1",
					style:"mt-2",h: 5 
				}) 
			},
			...
			rulesobj: {
                el: new input(config, {
                    no: 'rulesobj',
                    label: targetingItemsMultiVarFormat.t('rulesobj'),
                    value:"Rules6",
                    extraction: "TextAsIs",
                    required: true,
                    type: "character",
			...
			rulesobjhint: { 
				el: new labelVar(config, {
					label: targetingItemsMultiVarFormat.t('rulesobjhint'), 
                    no: "rulesobjhint",
					style:"mt-2",h: 6 
				}) 
			},
			...
			support: {
                el: new inputSpinner(config, {
                    no: 'support',
                    label: targetingItemsMultiVarFormat.t('support'),
                    min: 0,
                    max: 9999999,
                    step: 0.01,
                    value: 0.1,
			...
			supphint: { 
				el: new labelVar(config, { 
					label: targetingItemsMultiVarFormat.t('supphint'), 
                    no: "supphint",
					style:"mt-2",h: 6 
				}) 
			},
			...
			confidence: {
                el: new inputSpinner(config, {
                    no: 'confidence',
                    label: targetingItemsMultiVarFormat.t('confidence'),
                    min: 0,
                    max: 9999999,
                    step: 0.01,
                    value: 0.8,
			...
			confhint: { 
				el: new labelVar(config, { 
					label: targetingItemsMultiVarFormat.t('confhint'), 
                    no:"confhint",
					style:"mt-2",h: 6 
				}) 
			},
            ...
            label2: { 
				el: new labelVar(config, { 
					label: targetingItemsMultiVarFormat.t('label2'), 
                    no: "label2",
					style:"mt-2",h: 5 
				}) 
			},
            label3: { 
				el: new labelVar(config, { 
					label: targetingItemsMultiVarFormat.t('label3'), 
                    no: "label3",
					style:"mt-2",h: 5 
				}) 
			},            
			...
			lhs: {
                el: new input(config, {
                    no: 'lhs',
                    label: targetingItemsMultiVarFormat.t('lhs'),
                    value:"",
			...
			rhs: {
                el: new input(config, {
                    no: 'rhs',
                    label: targetingItemsMultiVarFormat.t('rhs'),
                    value:"",
                    extraction: "CreateArray|RemoveSpaces" ,
                    allow_spaces:true,
                    Type: "character",
			...
			both: {
                el: new input(config, {
                    no: 'both',
                    label: targetingItemsMultiVarFormat.t('both'),
                    value:"",
                    extraction: "CreateArray|RemoveSpaces" ,
                    allow_spaces:true,
                    Type: "character",
			...
			none: {
                el: new input(config, {
                    no: 'none',
                    label: targetingItemsMultiVarFormat.t('none'),
                    value:"",
                    extraction: "CreateArray|RemoveSpaces",
                    allow_spaces:true,
                    Type: "character",
            ...
            label4: { 
				el: new labelVar(config, { 
					label: targetingItemsMultiVarFormat.t('label4'), 
                    no: "label4",
					style:"mt-2",h: 5 
				}) 
			},
            ...
            both2: { 
				el: new radioButton(config, { 
					label: targetingItemsMultiVarFormat.t('rdboth'), 
					no: "defgrp", 
					increment: "both2", 
					value: "both", 
					state: "checked", 
            ...
            lhs2: { 
				el: new radioButton(config, { 
					label: targetingItemsMultiVarFormat.t('rdlhs'), 
					no: "defgrp", 
					increment: "lhs2", 
					value: "lhs", 
					state: "", 
            ...
            rhs2: { 
				el: new radioButton(config, { 
					label: targetingItemsMultiVarFormat.t('rdrhs'), 
					no: "defgrp", 
					increment: "rhs2", 
					value: "rhs", 
					state: "", 
            ...
            none2: { 
				el: new radioButton(config, { 
					label: targetingItemsMultiVarFormat.t('rdnone'), 
					no: "defgrp", 
					increment: "none2", 
					value: "none", 
					state: "", 
			...
			minlen: {
                el: new inputSpinner(config, {
                    no: 'minlen',
                    label: targetingItemsMultiVarFormat.t('minlen'),
                    min: 0,
                    max: 9999999,
                    step: 1,
                    value: 1,
			...
			maxlen: {
                el: new inputSpinner(config, {
                    no: 'maxlen',
                    label: targetingItemsMultiVarFormat.t('maxlen'),
                    min: 0,
                    max: 9999999,
                    step: 1,
                    value: 10,
			...
			sortopt: { 
				el: new labelVar(config, { 
					label: targetingItemsMultiVarFormat.t('sortopt'), 
                    no:"sortopt",
					style:"mt-2",h: 5 
				}) 
			},
			...
			sortby: { 
				el: new labelVar(config, { 
					label: targetingItemsMultiVarFormat.t('sortby'), 
                    no: "sortby",
					style:"mt-3",h: 5 
				}) 
			},
            rd1: { 
				el: new radioButton(config, { 
					label: targetingItemsMultiVarFormat.t('rd1'), 
					no: "sortgrp", 
					increment: "rd1", 
					value: "confidence", 
					state: "checked", 
            ...
            rd2: { 
				el: new radioButton(config, { 
					label: targetingItemsMultiVarFormat.t('rd2'), 
					no: "sortgrp", 
					increment: "rd2", 
					value: "lift", 
					state: "", 
            ...
            rd3: { 
				el: new radioButton(config, { 
					label: targetingItemsMultiVarFormat.t('rd3'), 
					no: "sortgrp", 
					increment: "rd3", 
					value: "support", 
					state: "", 
			...
			sortord: { 
				el: new labelVar(config, { 
					label: targetingItemsMultiVarFormat.t('sortord'), 
                    no: "sortord",
					style:"mt-3",
					h: 5 
				}) 
            ...
            increasing: { 
				el: new radioButton(config, { 
					label: targetingItemsMultiVarFormat.t('increasing'), 
					no: "ordergrp", 
            ...
            decreasing: { 
				el: new radioButton(config, { 
					label: targetingItemsMultiVarFormat.t('decreasing'), 
					no: "ordergrp", 
			...
			noofrules: { 
				el: new labelVar(config, { 
					label: targetingItemsMultiVarFormat.t('noofrules'), 
                    no:"noofrules",
					style:"mt-2",
					h: 5 
				}) 
			...
			rulecount: {
                el: new inputSpinner(config, {
                    no: 'rulecount',
                    label: targetingItemsMultiVarFormat.t('rulecount'),
                    min: 0,
                    max: 9999999,
                    step: 1,
                    value: 20,
            ...
            fromto: { 
				el: new radioButton(config, { 
					label: targetingItemsMultiVarFormat.t('fromto'), 
					no: "gpbox2", 
					increment: "fromto", 
					value: "", 
					state: "", 
			...
			from: {
                el: new inputSpinner(config, {
                    no: 'from',
                    label: targetingItemsMultiVarFormat.t('from'),
                    min: 0,
                    max: 9999999,
                    step: 1,
                    value: 1,
			...
			to: {
                el: new inputSpinner(config, {
                    no: 'to',
                    label: targetingItemsMultiVarFormat.t('to'),
                    min: 0,
                    max: 9999999,
                    step: 1,
                    value: 10,
		...
		var advoptions = {
            el: new optionsVar(config, {
                no: "advoptions",
                name: targetingItemsMultiVarFormat.t('advoptions'),
                content: [
                    objects.minlen.el,
                    objects.maxlen.el,
                    objects.sortopt.el,
        ...
        const content = {
            ...
            nav: {
                name: targetingItemsMultiVarFormat.t('navigation'),
                icon: "icon-target",
                modal: config.id
            }
        }
...
module.exports = {
    render: () => new targetingItemsMultiVarFormat().render()
}
